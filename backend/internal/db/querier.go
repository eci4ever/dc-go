...
type Querier interface {
	...
	GetAcademicOrganizationStatus(ctx context.Context, id string) (string, error)
	...
	ListOrganizationAuditLogs(ctx context.Context, arg ListOrganizationAuditLogsParams) ([]OrganizationAuditLog, error)
	ListOrganizationMembershipsByUserID(ctx context.Context, userID string) ([]ListOrganizationMembershipsByUserIDRow, error)
	...
	UpdateMemberPermissions(ctx context.Context, arg UpdateMemberPermissionsParams) (Member, error)

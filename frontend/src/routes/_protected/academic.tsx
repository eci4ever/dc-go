...
function AcademicPage() {
  ...
  const transcript = useQuery({
    ...
    enabled: Boolean(organizationId && selectedStudent && canManage),
  ...
  if (!canManage) {
    return (
      <Alert variant="destructive">
        ...
        <AlertDescription>
          Only institute owners and administrators can manage academic results.
        </AlertDescription>
      </Alert>
    );
  }
            ...
            <div className="grid gap-4 md:grid-cols-2 xl:grid-cols-4">
              <Field>
                ...
                <EntitySelect
                  ...
                  onChange={(studentId) => setResultForm((current) => ({ ...current, studentId }))}
                />
              </Field>
              <Field>
          ...
          {transcript.isPending && selectedStudent ? (
            ...
            <Empty>
              <EmptyHeader>
                ...
                <EmptyDescription>Enter the first course result for this student.</EmptyDescription>
              </EmptyHeader>
            </Empty>
          ) : null}
        </CardContent>
